...
ls Sample??.fasta | grep -o -P '^[^\.]+' | xargs -P 32 -I {} sh -c './Simera-master/Simera -i {}.fasta -o {}_simeraout -n 30 -s 25000 -l 0.00005 -c 10000 -f GTCGGTAAAACTCGTGCCAGC -r CATAGTGGGGTATCTAATCCCAGTTTG'
ls Blank??.fasta | grep -o -P '^[^\.]+' | xargs -P 32 -I {} sh -c './Simera-master/Simera -i {}.fasta -o {}_simeraout -n 30 -s 250 -l 0.00005 -c 10000 -f GTCGGTAAAACTCGTGCCAGC -r CATAGTGGGGTATCTAATCCCAGTTTG'
...
# Make "wSTD" sequences
ls Sample??.fasta Blank??.fasta | grep -o -P '^[^\.]+' | xargs -P 32 -I {} sh -c 'cat {}.fasta MiFish_STD_*.fasta > {}_wSTD.fasta'
# Perform chimera formation simulation
ls Sample??_wSTD.fasta | grep -o -P '^[^\.]+' | xargs -P 32 -I {} sh -c './Simera-master/Simera -i {}.fasta -o {}_simeraout -n 30 -s 50000 -l 0.00005 -c 10000 -f GTCGGTAAAACTCGTGCCAGC -r CATAGTGGGGTATCTAATCCCAGTTTG'
ls Blank??_wSTD.fasta | grep -o -P '^[^\.]+' | xargs -P 32 -I {} sh -c './Simera-master/Simera -i {}.fasta -o {}_simeraout -n 30 -s 500 -l 0.00005 -c 10000 -f GTCGGTAAAACTCGTGCCAGC -r CATAGTGGGGTATCTAATCCCAGTTTG'
# Replace abundance format
