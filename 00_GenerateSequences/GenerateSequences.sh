...
vsearch --fasta_width 0 --notrunclabels --threads 32 --cluster_fast 12Sbarcodes.fasta --qmask none --id 0.8 --strand plus --centroids 12Sbarcodes_representatives.fasta
